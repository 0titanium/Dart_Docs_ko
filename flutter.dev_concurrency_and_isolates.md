...
메인 아이솔레이트와 워커 아이솔레이트 사이에 양방향 통신을 설정하는 방법에 대한 자세한 설명은 Dart 설명서 의 예를 따르세요 .
...
모든 UI 작업과 Flutter 자체는 메인 아이솔레이트에 결합되어 있습니다. 따라서 스폰된 아이솔레이트를 사용하여 에셋에 액세스할 수 없으며 rootBundle, 스폰된 아이솔레이트에서 위젯이나 UI 작업을 수행할 수 없습니다.
